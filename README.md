...
​	This directory contains 2 parts, ch343 driver and gpio testing utility. This driver and application support USB to single serial port chip ch343/ch9101/ch9102, USB to dual serial ports chip ch342/ch9103, USB to quad serial ports chip ch344, etc.
