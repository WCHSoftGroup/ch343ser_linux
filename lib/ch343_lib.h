 ...
 * @enablebits: pointer to gpio function enable bits, bits0-15 on gpio0-15, 1 on enable
 * @gpiodirbits: pointer to gpio direction bits, bits0-15 on gpio0-15, 1 on ouput, 0 on input
 ...
 * @fd: file descriptor of tty device
 * @enablebits: gpio function enable bits, bits0-15 on gpio0-15, 1 on enable
 * @gpiodirbits: gpio enable bits, bits0-15 on gpio0-15, 1 on ouput, 0 on input
 *
 * The function return 0 if success, others if fail.
 */
